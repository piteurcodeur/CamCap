...
namespace WinFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load_1(object sender, EventArgs e)
        {
            ...
            if (!Directory.Exists(@"WinFormsApp2/repertoire"))
            {
                Directory.CreateDirectory(@"WinFormsApp2/repertoire");
            }
            try
            {
            ...
            {
                if (!Directory.Exists(@"WinFormsApp2/images"))
                {
                    Directory.CreateDirectory(@"WinFormsApp2/images");
                    AcquireImage(@"WinFormsApp2/images");
                }
            }
            /*
